...
<h6 class="text-center bg-dark text-white p-3 m-0">Designed and Developed by MMU DevTeam</h6>
...
<script>
    ...
    register_form.addEventListener('submit',(e)=>{
        ...
        var modal = bootstrap.Modal.getInstance(myModal);  // Corrected line
        modal.hide();
        ...
        xhr.onload = function(){
            if(this.responseText == 'pass_mismatch')
            {
                ...
                alert('error', "Send Confirmation Mail fail! Server down");
            }
            ...
            {
                alert('success',"Registration Successful.Please Check Your Email");
                register_form.reset();
            }
    ...
    login_form.addEventListener('submit',(e)=>{
        ...
        xhr.onload = function(){
            ...
            {
                alert('error', "Invalid Eamil or Phone Number");
            }
                ...
                alert('error', "Incorerect Password");
            }
            else
            {
    ...
    forgot_form.addEventListener('submit',(e)=>{
        ...
        xhr.onload = function(){
            if(this.responseText == 'inv_email')
            {
                ...
                alert('error', "Email is not verified, Please Contact Us!");
            }
            else if(this.responseText == 'inactive'){
                alert('error', "Account Suspended, Please Contact Us!");
            }
            else if(this.responseText == 'mail_failed'){
                alert('error', "Cannot send emial. Try again later");
            }
            else if(this.responseText == 'upd_failed'){
                alert('error', "Account recovery failed. Try Again later");
            }
            else
            {
