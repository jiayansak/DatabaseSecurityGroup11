...
<nav id ="navbar" class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 p-lg-2 shadow-sm sticky-top">
                ...
                <form id="register-form">
                    ...
                    <div class="modal-body">
                        <span class="badge rounded-pill bg-light text-dark mb-3 text-wrap lh-base">
                            Note: Your details must match with Your ID(IC Card/ Passport)
            ...
            <div class="modal-content">
                <form id="forgot-form" >
                    ...
                    <div class="modal-body">
                        <div class="mb-4">
                            <span class="badge rounded-pill bg-light text-dark mb-3 text-wrap lh-base">
                                Note: the link will be sent to your email to reset password!
                            </span>
                            <label class="form-label">Email</label>
