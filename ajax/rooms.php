<?php
    ...
    if(isset($_GET['fetch_rooms']))
    {
        ...
        $adults = isset($guests['adults']) && $guests['adults'] != '' ? $guests['adults'] : 0;
        $children = isset($guests['children']) && $guests['children'] != '' ? $guests['children'] : 0;
        ...
        //check website is shutdown or not
        $settings_q="SELECT * FROM `setting` WHERE `sr_no`=1";
                ...
                <div class='card mb-4 border-0 shadow'>
                    <div class='row g-0 p-3 align-items-center'>
                        ...
                        <div class='col-md-2 mt-lg-0 mt-md-0 mt-4 text-center '>
                            ...
                            $book_btn
                            <a href='room_details.php?id=$room_data[id]' class='btn btn-sm w-100 btn-outline-dark shadow-none'>View Room</a>
                        </div>
                    </div>
                </div>
            ";
