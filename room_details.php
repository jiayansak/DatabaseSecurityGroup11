                    ...
                    <div>
                        <div class="swiper-slide bg-white p-4">
                            <div class="d-flex align-items-center mb-2">
                                <img src="Image/users/review.jpg" width="30px">
                                <h6 class="m-0 ms-2">Jason Lee</h6>
                            </div>
                            <p>
                            As the proud owner of this exquisite hotel, I recently had the pleasure of experiencing our Super Extra Premium Room. 
                            The blend of spacious elegance, high-end furnishings, and personalized services exceeded even my expectations, 
                            ensuring an indulgent stay that reflects the epitome of luxury.
                            </p>
                            <div class="rating">
                                <i class="bi bi-star-fill text-warning"></i>
                                <i class="bi bi-star-fill text-warning"></i>
