    ...
    function add_image()
    {
        ...
        xhr.onload = function()
        {
            if(this.responseText == 'inv_img'){
                alert('error','Only WEBP or and PNG images are allowed!');
            }
    ...
    function rem_image(img_id,room_id)
    {
        ...
        xhr.onload = function()
        {
            if(this.responseText == 1){
                ...
                alert('error','Image remove fail','image-alert');
            }
        }
        xhr.send(data);
    }
    ...
    function thumb_image(img_id,room_id)
    {
        ...
        xhr.onload = function()
        {
            if(this.responseText == 1)
            {
                ...
                alert('error','Thumbnail remove fail','image-alert');
            }
        }
        xhr.send(data);
    }
