<?php
    ...
    if(isset($_POST['add_room']))
    {
        ...
        $faciliteis = filteration(json_decode($_POST['facilities']));
    ...
    if(isset($_POST['add_image']))
    {
        ...
        if($img_r=='inv_img'){
            ...
            $q="INSERT INTO `room_images`(`image`,`room_id`) VALUES (?,?)";
            $values = [$img_r,$frm_data['room_id']];
    ...
    if(isset($_POST['get_room_images']))
    {
        ...
        while($row = mysqli_fetch_assoc($res))
        {
            if($row['thumb']==1)
            {
                $thumb_btn="<i class='bi bi-check2-circle text-light bg-success px-2 py-1 rounded fs-5'></i>";
            }
            else{
    ...
    if (isset($_POST['rem_image'])) 
    {
        ...
        $deleted = deleteImage($img['image'], ROOMS_FOLDER);
